...
int main(){
  ...
  std::string audioTextFile = "Binaural_Test.txt";
  //std::cout >> "hi";
  //LoadAudio(audioTextFile, 1,1);
  //int num_samples =  ;
  int num_ears = 1;
  int num_channels = 96;
  FPType sample_rate = 22050;
  //if sample_rate == 22050{num_channels = 96;}
  //else {num_channels = 114;}
...
//All below: Don't touch! Not mine (Daniel's)!
...
*/
  ...
  CARParams car_params_; //Change(galv): Carparams to CARPARAMS
  IHCParams ihc_params_;
  AGCParams agc_params_;
  bool open_loop_;
};
